...
*********************************************************************/
#ifndef _INTERFACELWPRDYNAMIC_H_
#define _INTERFACELWPRDYNAMIC_H_

#include <vector>
#include <interfaces.h>
#include "dynamicalLWPR.h"
#include "ui_paramsLWPRDynamic.h"

class DynamicLWPR : public QObject, public DynamicalInterface
{
	Q_OBJECT
...
public:
	...
	void DrawInfo(Canvas *canvas, Dynamical *dynamical);
...
#endif // _INTERFACELWPRDYNAMIC_H_

...
*********************************************************************/
#ifndef _INTERFACELWPRREGRESS_H_
#define _INTERFACELWPRREGRESS_H_

#include <vector>
#include <interfaces.h>
#include "regressorLWPR.h"
#include "ui_paramsLWPRRegress.h"

class RegrLWPR : public QObject, public RegressorInterface
{
	Q_OBJECT
	Q_INTERFACES(RegressorInterface)
private:
	QWidget *widget;
	Ui::ParametersLWPRRegress *params;
public:
	RegrLWPR();
    ~RegrLWPR();

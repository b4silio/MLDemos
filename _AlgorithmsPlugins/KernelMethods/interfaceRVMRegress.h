...
*********************************************************************/
#ifndef _INTERFACERVMREGRESS_H_
#define _INTERFACERVMREGRESS_H_

#include <vector>
#include <interfaces.h>
#include "regressorRVM.h"
#include "ui_paramsRVMregr.h"

class RegrRVM : public QObject, public RegressorInterface
{
	Q_OBJECT
...
public:
	...
	// virtual functions to manage the GUI and I/O
        QString GetName(){return QString("Relevance Vector Regression");}

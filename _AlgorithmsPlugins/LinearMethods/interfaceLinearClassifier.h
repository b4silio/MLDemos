...
*********************************************************************/
#ifndef _INTERFACELINEARCLASSIFIER_H_
#define _INTERFACELINEARCLASSIFIER_H_

#include <vector>
#include <interfaces.h>
#include "classifierLinear.h"
#include "ui_paramsLinear.h"

class ClassLinear : public QObject, public ClassifierInterface
{
	Q_OBJECT

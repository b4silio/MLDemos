...
*********************************************************************/
#ifndef PLUGINMEANSHIFT_H
#define PLUGINMEANSHIFT_H
...
class PluginMeanShift : public QObject, public CollectionInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "PluginMeanShift" FILE "plugin.json")
    Q_INTERFACES(CollectionInterface)
public:
    PluginMeanShift();
    QString GetName(){return "Mean Shift Clustering";}
};
#endif // PLUGINMEANSHIFT_H

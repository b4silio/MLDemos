...
*********************************************************************/
#ifndef _INTERFACEEXAMPLECLASSIFIER_H_
#define _INTERFACEEXAMPLECLASSIFIER_H_
...
/**
  Example of plugin interface for a classifier
  */
class ClassExample : public QObject, public ClassifierInterface
{
	Q_OBJECT
...
#endif // _INTERFACEEXAMPLECLASSIFIER_H_
